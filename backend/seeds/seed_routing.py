...
Usage:
  cd backend cd gateway && source venv/bin/activate && python seed_routing.pycd gateway && source venv/bin/activate && python seed_routing.py source venv/bin/activate cd gateway && source venv/bin/activate && python seed_routing.pycd gateway && source venv/bin/activate && python seed_routing.py python seeds/seed_routing.py
"""
import uuid
