...
echo ===================================================
start "TAPIOD Backend" cmd /k "cd backend && set PYTHONIOENCODING=utf-8 && .\venv\Scripts\activate && litellm --config litellm_config.yaml --port 4000"

echo ===================================================
echo   Starting TAPIOD Frontend (Next.js Dashboard)
echo ===================================================
start "TAPIOD Frontend" cmd /k "cd frontend && npm run dev"
